...
public class ProductGroupTest {
    ...
    public void testAddProduct() {
        ...
        assertThat(group.getProducts(), Matchers.hasItem(product));
        ProductGroup otherGroup = (ProductGroup) getField(product, "group");
    ...
    public void testAddEmptyChildToEmptyParent() {
        ...
        assertThat((List<ProductGroup>) getField(parent, "children"), Matchers.hasItems(child));
    }
    ...
    public void testAddEmptyChildToParentGroupWithProducts() {
        ...
        assertThat(child.getProducts(), Matchers.hasItems(product1, product2));
